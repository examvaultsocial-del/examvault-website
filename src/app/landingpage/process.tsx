...
const steps = [
  {
    number: '1.',
    title: 'Find',
    description: 'Choose the exam & topic you need.',
    icon: '/assets/process-icons/search-mignifiying.svg',
  },
  {
    number: '2.',
    title: 'Buy',
    description: 'Secure payment & instant access.',
    icon: '/assets/process-icons/cart-store.svg',
  },
  {
    number: '3.',
    title: 'Download',
    description: 'Get high-quality PDF instantly.',
    icon: '/assets/process-icons/cloud-download.svg',
  },
  {
    number: '4.',
    title: 'Succeed',
    description: 'Study smart & achieve your dream.',
    icon: '/assets/process-icons/trophy.svg',
  },
];
          ...
          <React.Fragment key={index}>
            ...
            <div className="flex flex-col items-center text-center space-y-2 max-w-[220px] group">
              ...
              <div className="flex flex-col space-y-1">
                <h3 className="text-xl font-bold text-[#1A1A2E] flex items-baseline gap-1.5 justify-center">
                  <span className="text-[#B59410] font-sketch">{step.number}</span>
                  {step.title}
                </h3>
                <p className="text-[13px] text-[#4A4A68] font-semibold leading-relaxed">
                  {step.description}
                </p>
              </div>
            </div>
